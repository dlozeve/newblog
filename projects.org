...
** [[https://getleibniz.com/][Leibniz]]

My take on what project scheduling software should be. Read the [[./posts/leibniz-product-vision.html][blog post]].

** [[https://github.com/dlozeve/diceroll][Diceroll]]

Roll some dice from the command line, parsing dice expressions as used
...
Also available at [[https://diceroll.run/][diceroll.run]]. See the [[./posts/diceroll.html][blog post]].
